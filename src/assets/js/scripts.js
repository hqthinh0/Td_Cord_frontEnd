...
var Common = (function () {
	 ...
	 * Form
	 */
	Common.prototype.jsForm = function () {
		$('.frm-base-input').focus(function () {
			let getTh = $(this).closest('tr').find('th');
			getTh.addClass('animate');
			$(this).focusout(function () {
				$(this).val() == '' ? getTh.removeClass('animate') : '';
			});
		});
	};
	...
	Common.prototype.jsPageTop = function () {
		...
		$(window).scroll(function () {
			if ($(this).scrollTop() > 100) {
				$('.nav-backtotop').fadeIn();
			} else {
				$('.nav-backtotop').fadeOut();
			}
		});
